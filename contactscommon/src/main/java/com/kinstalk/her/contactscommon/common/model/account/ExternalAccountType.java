...
package com.kinstalk.her.contactscommon.common.model.account;
...
public class ExternalAccountType extends BaseAccountType {
    ...
    public static XmlResourceParser loadContactsXml(Context context, String resPackageName) {
        ...
        @SuppressLint("WrongConstant") final List<ResolveInfo> intentServices = pm.queryIntentServices(intent,
