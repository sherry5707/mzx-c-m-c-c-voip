...
final public class RawContact implements Parcelable {
    ...
    final public static class NamedDataItem implements Parcelable {
        ...
        public static final Creator<NamedDataItem> CREATOR
                = new Creator<NamedDataItem>() {
     ...
     */
    public static final Creator<RawContact> CREATOR
            = new Creator<RawContact>() {
    ...
    public String toString() {
        ...
        for (NamedDataItem namedDataItem : mDataItems) {
