...
import com.kinstalk.her.contactscommon.common.model.BuilderWrapper;
import com.kinstalk.her.contactscommon.common.model.CPOWrapper;
...
public class RawContactDelta implements Parcelable {
    ...
    /**
     * Consider building the given {@link Builder} and
    ...
    public static final Creator<RawContactDelta> CREATOR =
            new Creator<RawContactDelta>() {
