...
package com.kinstalk.her.common.common.contacts;
...
import com.kinstalk.her.common.common.widget.CompositeCursorAdapter;
 ...
 * and/or contact name. It also searches registered {@link ContactsContract.Directory}'s.
 */
public abstract class BaseEmailAddressAdapter extends CompositeCursorAdapter implements Filterable {
    ...
    /**
     * Model object for a {@link ContactsContract.Directory} row. There is a partition in the
     * {@link CompositeCursorAdapter} for every directory (except
     * {@link ContactsContract.Directory#LOCAL_INVISIBLE}.
     */
