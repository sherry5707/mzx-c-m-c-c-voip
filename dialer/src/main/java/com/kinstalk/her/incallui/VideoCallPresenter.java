...
import com.kinstalk.her.incallui.InCallPresenter.InCallOrientationListener;
...
import com.kinstalk.her.incallui.InCallVideoCallCallbackNotifier.SurfaceChangeListener;
import com.kinstalk.her.incallui.InCallVideoCallCallbackNotifier.VideoEventListener;
...
//                && call.getVideoFeatures().supportsRotation()
    ...
    private static void updateCameraSelection(Call call) {
        ...
        if (call == null) {
            ...
            Log.e(TAG, "updateCameraSelection: Call object is null."
        ...
        Log.d(TAG, "updateCameraSelection: Setting camera direction to " +
                cameraDir + " Call=" + call);
        final InCallCameraManager cameraManager = InCallPresenter.getInstance().
                getInCallCameraManager();
