...
public class DialpadPresenter extends Presenter<DialpadPresenter.DialpadUi>
    ...
    private static final HashMap< Character,Integer> mKeyCodeMap =
    ...
    static {
        ...
        mKeyCodeMap.put('1',8);
        mKeyCodeMap.put('2',9);
        mKeyCodeMap.put('3',10);
        mKeyCodeMap.put('4',11);
        mKeyCodeMap.put('5',12);
        mKeyCodeMap.put('6',13);
        mKeyCodeMap.put('7',14);
        mKeyCodeMap.put('8',15);
        mKeyCodeMap.put('9',16);
        mKeyCodeMap.put('#',18);
        mKeyCodeMap.put('*',17);
    }
    @Override
...
//            TelecomAdapter.getInstance().playDtmfTone(mCall.getId(), c);
            ...
            //add by mengzhaoxue for sendDTMF:
            int key = mKeyCodeMap.get(c);
            Log.i(this, "processDtmf: key:"+key);
            CmccService.sendDTMF(key);
