...
import com.kinstalk.her.incallui.InCallPresenter.InCallDetailsListener;
import com.kinstalk.her.incallui.InCallPresenter.InCallEventListener;
import com.kinstalk.her.incallui.InCallPresenter.InCallState;
import com.kinstalk.her.incallui.InCallPresenter.InCallStateListener;
import com.kinstalk.her.incallui.InCallPresenter.IncomingCallListener;
import com.kinstalk.her.incallui.InCallPresenter.PhoneRecorderListener;
import com.kinstalk.her.incallui.util.Ui;
...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
        ...
        , PhoneRecorderListener,InCallPresenter.PickUpCallListener {

    @Override
    public void pickUpCall() {
        getUi().setEndCallButtonEnabled(true,true);
    }
...
//                ExtensionManager.getRCSeCallCardExt().onImageLoaded(callId, entry);
    ...
    public void onUiReady(CallCardUi ui) {
        ...
        /// @}
        // add for pick up call by mengzhaoxue
        InCallPresenter.getInstance().setPickUpListener(this);
    }
...
//                getAccountForCall(mSecondary));
        ...
        final boolean canSwipeCall = mPrimary != null
            && mPrimary.getSessionModificationState()
                != Call.SessionModificationState.WAITING_FOR_UPGRADE_RESPONSE
            && mPrimary.getSessionModificationState()
                != Call.SessionModificationState.RECEIVED_UPGRADE_TO_VIDEO_REQUEST
...
//        if (FeatureOptionWrapper.isSupportDSDA()
//                && InCallUtils.isTwoIncomingCalls()) {
