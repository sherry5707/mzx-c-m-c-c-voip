...
package com.kinstalk.her.incallui.recorder;
...
public class PhoneRecorderUtils {
    ...
    public static final String STORAGE_SETTING_INTENT_NAME
    ...
    public static final long PHONE_RECORD_LOW_STORAGE_THRESHOLD = 2L * 1024L * 1024L;
...
//            }
//        }
//        Log.d(LOG_TAG, "volumes len:" + volumes.length + " count:" + count);
        return count;
    }
