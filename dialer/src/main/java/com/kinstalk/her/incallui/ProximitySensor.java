...
import com.kinstalk.her.incallui.AudioModeProvider.AudioModeListener;
...
public class ProximitySensor implements AccelerometerListener.OrientationListener,
    ...
    private synchronized void updateProximitySensorMode() {
        ...
        // is being held in a horizontal position.
            ...
            Log.i(this, MoreObjects.toStringHelper(this)
    ...
    /**
     * M: add onDetailChange for update updateProximitySensorMode again when vilte call
     * downgrade to volte call and vice versa.
     * @param call
     * @param details
     */
    @Override
    public void onDetailsChanged(Call call, android.telecom.Call.Details details) {
        if (call == null) {
            ...
            // M: fix CR:ALPS02550197,null pointer dereferences.
            return;
        }
        if (CallList.getInstance().getFirstCall() == call) {
            int newVideoState = call.getVideoState();
            if (mCurVideoState != newVideoState) {
                updateProximitySensorMode();
            }
            mCurVideoState = newVideoState;
        }
    }
