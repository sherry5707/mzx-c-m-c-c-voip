...
import com.kinstalk.her.contactscommon.common.util.PhoneNumberHelper;
import com.kinstalk.her.dialer.R;
import com.kinstalk.her.dialer.calllog.ContactInfo;
import com.kinstalk.her.dialer.service.CachedNumberLookupService;
import com.kinstalk.her.dialer.service.CachedNumberLookupService.CachedContactInfo;
import com.kinstalk.her.dialer.util.MoreStrings;
import com.kinstalk.her.incallui.Call.LogState;
import com.kinstalk.her.incallui.service.PhoneNumberService;
...
public class ContactInfoCache implements ContactsAsyncHelper.OnImageLoadCompleteListener {
    ...
    private ContactInfoCache(Context context) {
        ...
        mCachedNumberLookupService =
                com.kinstalk.her.dialerbind.ObjectFactory.newCachedNumberLookupService();
    ...
    public void maybeInsertCnapInformationIntoCache(Context context, final Call call,
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                contactInfo.type = Phone.TYPE_MAIN;
                try {
        ...
        */
        ...
        if (didLocalLookup) {
            ...
            if (!callerInfo.contactExists && mPhoneNumberService != null) {
                ...
                String callNo = null;
//                        PhoneNumberUtils.normalizeNumber(InCallUIVolteUtils.getPhoneNumber(
