...
//                mTelecomCall.getVideoCall().registerCallbackAndFetchContacts(mVideoCallCallback);
...
//                + State.toString(oldState) + " -> " + State.toString(newState));
    ...
    /// M: Save the previous video call object to avoid call VideoCall.registerCallbackAndFetchContacts frequently.
...
//                mVideoCallCallback = new InCallVideoCallCallback(this);
//            }
//            getVideoCall().registerCallbackAndFetchContacts(mVideoCallCallback);
        }
    }
    /** @} */
