...
package com.kinstalk.her.incallui.widget.multiwaveview;
    ...
    private void switchToState(int state, float x, float y) {
        switch (state) {
            case STATE_IDLE:
                ...
                hideTargets(false, false);
                /// @}
                /// M: Do NOT trigger glow animation again after doFinish()
                /// AnimationHandler has risk of callbacks leak when start animation
                /// during call endAnimation.
