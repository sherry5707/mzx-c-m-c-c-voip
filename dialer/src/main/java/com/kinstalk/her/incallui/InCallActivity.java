...
import com.kinstalk.her.cmccmode.utils.SystemPropertiesProxy;
import com.kinstalk.her.contactscommon.common.activity.TransactionSafeActivity;
...
import com.kinstalk.her.incallui.Call.State;
import com.kinstalk.her.incallui.util.AccessibilityUtil;
...
public class InCallActivity extends TransactionSafeActivity implements FragmentDisplayManager {
    ...
    private static final int SCREEN_HEIGHT_RESIZE_THRESHOLD =
            "tablet".equals(SystemPropertiesProxy.getString(DialerApplication.getContext(), "ro.build.characteristics")) ? 500 : 400;
    ...
    public static final String INCALL_ACTIVITY_FINISH_ACTION = "incall_activity_finish_receiver";
    private BroadcastReceiver finishReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (INCALL_ACTIVITY_FINISH_ACTION.equals(intent.getAction())) {
                Log.i(this, "finish inCallActivity");
                finish();
            }
        }
    };
    ...
    private void registerFinishReceiver() {
        ...
        filter.addAction(INCALL_ACTIVITY_FINISH_ACTION);
        registerReceiver(finishReceiver, filter);
    }

    public static void actionFinish() {
        Intent intent = new Intent(INCALL_ACTIVITY_FINISH_ACTION);
...
//        }
        //add by mengzhaoxue
//        int callType = getIntent().getIntExtra("type", TYPE_CALLIN);
//        Log.i(this,"callType:"+callType);
//        if (callType == TYPE_CALLIN) {
//            showAnswerFragment(true);
//        } else if (callType == TYPE_CALLOUT) {
//            showCallCardFragment(true);
//        }
        //end
        /// @}
...
//        ExtensionManager.getRCSeInCallExt().onDestroy(this);
    ...
    public void onFragmentAttached(Fragment fragment) {
        Log.i(this, "onFragmentAttached:" + fragment);
...
//        ExtensionManager.getRCSeInCallExt().onNewIntent(intent);
    ...
    private void internalResolveIntent(Intent intent) {
        Log.i(TAG, "internalResolveIntent");
...
//                showCallCardFragment(true);
                //add by mengzhaoxue
                callType = getIntent().getIntExtra("type", TYPE_CALLIN);
                Log.e(this, "callType:" + callType);
                if (callType == TYPE_CALLIN) {
                    showCallCardFragment(true);
                    showAnswerFragment(true);
                } else if (callType == TYPE_CALLOUT) {
    ...
    private Fragment createNewFragmentForTag(String tag) {
        if (TAG_DIALPAD_FRAGMENT.equals(tag)) {
            ...
            if (AccessibilityUtil.isTalkBackEnabled(this)) {
                ...
                Log.i(this, "GlowPadAnswerFragment");
                mAnswerFragment = new GlowPadAnswerFragment();
                Bundle bundle = new Bundle();
                String phoneNumber = getIntent().getStringExtra("phone_number");
                Log.i(this, "phoneNumber:" + phoneNumber);
                bundle.putString("phone_number", phoneNumber);
                bundle.putInt("type", callType);
            ...
            bundle.putInt("type", callType);
            mCallCardFragment.setArguments(bundle);
            return mCallCardFragment;
        }
...
//        }
        ...
        else if ( !isFinishing() && InCallUiWfcUtils
                .maybeShowCongratsPopup(this, disconnectCause)){
        }*/
        else {
...
//        OnClickListener cancelClickListener = newOnClickListener() {
//            public void onClick(DialogInterface dialog, int which) {
...
//
//        if (isSDCardExist) {
//            OnClickListener oKClickListener = newOnClickListener() {
//                public void onClick(DialogInterface dialog, int which) {
//                    Log.d(this, "showStorageDialog... , on click, which=" + which);
//                    if (null != mDialog) {
//                        mDialog.dismiss();
...
//        mDialog.show();
    ...
    private void setWindowFlag() {
        ...
        if (call != null && State.isConnectingOrConnected(call.getState())) {
