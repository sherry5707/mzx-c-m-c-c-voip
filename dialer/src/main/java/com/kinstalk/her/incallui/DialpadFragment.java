...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    private class DTMFKeyListener extends DialerKeyListener {
        ...
        public boolean onKeyDown(View view, Editable content,
            ...
            if (event.getRepeatCount() == 0 && super.onKeyDown(view, content, keyCode, event)) {
                ...
                // code.
                if (keyOK) {
                    Log.e(this, "DTMFKeyListener reading '" + c + "' from input.");
                    getPresenter().processDtmf(c);
                } else {
                    Log.e(this, "DTMFKeyListener rejecting '" + c + "' from input.");
                }
                return true;
            }
            return false;
    ...
    public void updateColors() {
        Log.e(this,"updateColors,getThemeColor:"+InCallPresenter.getInstance().getThemeColors());
    ...
    public void appendDigitsToField(char digit) {
        Log.i(this,"digit:"+digit);
        if (mDtmfDialerField != null) {
            Log.i(this,"mDtmfDialerField is not null");
