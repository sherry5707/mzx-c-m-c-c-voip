...
public class OkhttpClientHelper {
    ...
    private static HttpLoggingInterceptor sLogInterceptor = new HttpLoggingInterceptor(new VoipLog.HttpLogger(TAG))
            .setLevel(HttpLoggingInterceptor.Level.BODY);
    private static final int CONNECT_TIMEOUT = 10;
    private static final int READ_TIMEOUT = 10;
    private static final int WRITE_TIMEOUT = 10;
    private static OkHttpClient sSafeClient;
    private static final boolean SHOW_OKHTTP_LOG = !VoipLog.isUserType();
     /**
     * 拦截器  给所有的请求添加消息头
     */
