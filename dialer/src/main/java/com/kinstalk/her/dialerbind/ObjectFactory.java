...
public class ObjectFactory {
    ...
    public static String getFilteredNumberProviderAuthority() {
        return "com.kinstalk.her.dialer.database.filterednumberprovider";
    }

    public static String getMyDBProviderAuthority() {
        return "com.kinstalk.her.dialer.database.mydbprovider";
    }

    public static String getVoicemailArchiveProviderAuthority() {
        return "com.kinstalk.her.dialer.database.voicemailarchiveprovider";
    }
