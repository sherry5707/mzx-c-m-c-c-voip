...
public final class DialerCompatUtils {
     ...
     * {link android.provider.CallRecord.Calls.CACHED_PHOTO_URI} column
     *
     * @return {@code true} if {link android.provider.CallRecord.Calls.CACHED_PHOTO_URI} is available,
