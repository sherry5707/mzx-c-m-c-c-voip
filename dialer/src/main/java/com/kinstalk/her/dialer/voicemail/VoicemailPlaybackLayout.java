...
package com.kinstalk.her.dialer.voicemail;
...
import com.kinstalk.her.dialer.util.AsyncTaskExecutor;
import com.kinstalk.her.dialer.util.AsyncTaskExecutors;
...
public class VoicemailPlaybackLayout extends LinearLayout
     ...
     */
    private final OnClickListener mSpeakerphoneListener = new OnClickListener() {
        @Override
     ...
     */
    private final OnClickListener mStartStopButtonListener = new OnClickListener() {
        @Override
    ...
    private final OnClickListener mDeleteButtonListener = new OnClickListener() {
        @Override
        public void onClick(View view ) {
            if (mPresenter == null) {
                return;
    ...
    private final OnClickListener mArchiveButtonListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private final OnClickListener mShareButtonListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (mPresenter == null || isArchiving(mVoicemailUri)) {
                return;
