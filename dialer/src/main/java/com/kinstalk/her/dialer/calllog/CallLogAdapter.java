...
package com.kinstalk.her.dialer.calllog;
...
import com.kinstalk.her.contactscommon.common.compat.PhoneNumberUtilsCompat;
...
import com.kinstalk.her.dialer.PhoneCallDetails;
import com.kinstalk.her.dialer.R;
import com.kinstalk.her.dialer.calllog.calllogcache.CallLogCache;
import com.kinstalk.her.dialer.contactinfo.ContactInfoCache;
import com.kinstalk.her.dialer.contactinfo.ContactInfoCache.OnContactInfoChangedListener;
import com.kinstalk.her.dialer.database.FilteredNumberAsyncQueryHandler;
import com.kinstalk.her.dialer.database.VoicemailArchiveContract;
import com.kinstalk.her.dialer.filterednumber.BlockNumberDialogFragment.Callback;
...
import com.kinstalk.her.dialer.util.PhoneNumberUtil;
...
public class CallLogAdapter extends GroupingListAdapter
     ...
     * put into the primary call groups in {@link CallLogGroupBuilder},
    ...
    private final View.OnClickListener mExpandCollapseListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (viewHolder.getAdapterPosition() == mCurrentlyExpandedPosition) {
                Log.i(TAG, "onClick: mCurrentlyExpandedPosition");
                ...
                Log.i(TAG, "onClick: not mCurrentlyExpandedPosition,it will expandViewHolderActions");
...
//        Log.i(TAG, "expandViewHolderActions: showActions");
...
////        mCurrentlyExpandedRowId = viewHolder.rowId;
        //add by mengzhaoxue:click action is callout
        Log.i(TAG, "expandViewHolderActions: displayNumber:" + viewHolder.displayNumber
                + ",number:" + viewHolder.number + ",name:" + viewHolder.nameOrNumber);
        //获取的数据是：displayNumber:156 5188 6105,number:15651886105,name:156 5188 6105或者：
        //displayNumber:displayNumber:15,number:15,name:孟照雪
        if (DeviceStatusUtil.getEnabledStatus(mContext) == 0) {
            AIManager.getInstance(mContext).playTextWithStr(
                    mContext.getString(R.string.tts_device_disabled),null);
            Toast.makeText(mContext, mContext.getString(R.string.device_disnabled), Toast.LENGTH_SHORT).show();
        } else if (DeviceStatusUtil.getEnabledStatus(mContext) == 1) {
            CmccService.callOutByNumber(viewHolder.number);
//            DialerApplication.callOut(DialerApplication.getContext(), viewHolder.number);
        }
    }
    ...
    private void bindCallLogListViewHolder(ViewHolder viewHolder, int position) {
        ...
        //add by mengzhaoxue
        final String nickName = c.getString(CallLogQuery.CACHED_NAME);
        //end
...
//        if (!TextUtils.isEmpty(info.name) || !TextUtils.isEmpty(info.nameAlternative)) {
     ...
     * populated in {@link CallLogGroupBuilder}.
     *
