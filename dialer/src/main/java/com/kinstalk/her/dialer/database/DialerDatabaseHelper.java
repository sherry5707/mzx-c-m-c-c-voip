...
package com.kinstalk.her.dialer.database;
...
import com.kinstalk.her.contactscommon.common.util.StopWatch;
import com.kinstalk.her.dialer.R;
import com.kinstalk.her.dialer.database.FilteredNumberContract.FilteredNumberColumns;
import com.kinstalk.her.dialer.database.VoicemailArchiveContract.VoicemailArchive;
...
import static com.kinstalk.her.cmccmode.data.MyDBProvider.AUTHORITY_URI;
...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_LAST_CREATED_SHARED_PREF = "com.kinstalk.her.dialer";
    ...
    public interface Tables {
        ...
        /** 自己的联系人table**/
        static final String ALLCONTACTS_TABLE = "all_contacts_table";
        /** 自己的通话记录table**/
        static final String HISTORY_CALL_RECORDS_TABLE = "history_call_records_table";
        /** 自己的设备信息table**/
        static final String DEVICE_STATUS_TABLE = "device_status_table";
        /** Database properties for internal use */
        static final String PROPERTIES = "properties";
    }

    public static final Uri SMART_DIAL_UPDATED_URI =
            Uri.parse("content://com.kinstalk.her.dialer/smart_dial_updated");
    ...
    public static interface UpdatedContactQuery {
        static final Uri URI = Contacts.CONTENT_URI;
    ...
    public interface AllContactsColumns extends BaseColumns {
        String ALLCONTACTS_TABLE = "all_contacts_table";
        Uri CONTENT_URI = AUTHORITY_URI.buildUpon().appendPath(ALLCONTACTS_TABLE).build();
        String CONTACT_ID = "contact_id";
        String NICK_NAME = "nick_name";
        String SORT_KEY = "sort_key";
        String DEFAULT_SORT_ORDER = SORT_KEY + " ASC";
    }

    public interface DeviceStatusColumns extends BaseColumns {
        String DEVICESTATUS_TABLE = "device_status_table";
        Uri CONTENT_URI = AUTHORITY_URI.buildUpon().appendPath(DEVICESTATUS_TABLE).build();
        String ID = "id";
        String BIND_STATUS = "bind_status";
        String ENABLED_STATUS = "enabled_status";
        String APP_KEY = "appt_key";
        String APP_SECRET = "app_secret";
        //标记是否在通话过程中
        String IN_CALL = "is_in_call";
        //标记是否在响铃过程中
        String CALL_ALERTING = "call_alerting";
        //标记和家固话是否已经登录
        String HJGH_LOGIN_STATUS = "hjgh_login_status";
        /**
         * 想要做的uri是device_status_table中任意行中的bind_status列
         * content://com.kinstalk.her.dialer.database.mydbprovider/device_status_table/#/bind_status
         **/
//        Uri CONTENT_BIND_URI = AUTHORITY_URI.buildUpon().appendPath(DEVICESTATUS_TABLE + "/#/" + BIND_STATUS).build();
//        Uri CONTENT_ENABLED_URI = AUTHORITY_URI.buildUpon().appendPath(DEVICESTATUS_TABLE + "/#/" + ENABLED_STATUS).build();
//        Uri CONTENT_KEY_URI = AUTHORITY_URI.buildUpon().appendPath(DEVICESTATUS_TABLE + "/#/" + APP_KEY).build();
//        Uri CONTENT_SECRET_URI = AUTHORITY_URI.buildUpon().appendPath(DEVICESTATUS_TABLE + "/#/" + APP_SECRET).build();
    }

//    public interface HistoryCallRecordsColumns extends BaseColumns {
//        String HISTORY_CALLRECORDS_TABLE = "history_call_records_table";
//        Uri CONTENT_URI = AUTHORITY_URI.buildUpon().appendPath(HISTORY_CALLRECORDS_TABLE).build();
//        String ID = "id";
//        /**通话人姓名**/
//        String NICK_NAME = "nick_name";
//        /**呼入还是呼出，呼入：0；呼出1**/
...
//        int TYPE_CALLOUT = 1;
//        /**标记是否接通（为了未接呼入）**/
//        String IS_CALL_SUCCESS = "is_call_success";
//        int CALL_SUCCESS = 1;
//        int CALL_FAIL = 0;
//        /**通话时间**/
//        String date = "date";
//    }
    ...
    private void setupTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.ALLCONTACTS_TABLE + " ("
                + AllContactsColumns.CONTACT_ID + " INTEGER PRIMARY KEY, "
                + AllContactsColumns.NICK_NAME + " TEXT,"
                + AllContactsColumns.SORT_KEY + " TEXT"
                + ");");
//        db.execSQL("CREATE TABLE " + Tables.HISTORY_CALL_RECORDS_TABLE + " ("
//                + HistoryCallRecordsColumns.ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
//                + HistoryCallRecordsColumns.NICK_NAME + " TEXT,"
//                + HistoryCallRecordsColumns.TYPE + " INTEGER,"
//                + HistoryCallRecordsColumns.IS_CALL_SUCCESS + " INTEGER,"
//                + HistoryCallRecordsColumns.date + " LONG"
//                + ");");
        db.execSQL("CREATE TABLE " + Tables.DEVICE_STATUS_TABLE + " ("
                + DeviceStatusColumns.ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + DeviceStatusColumns.APP_KEY + " TEXT,"
                + DeviceStatusColumns.APP_SECRET + " TEXT,"
                + DeviceStatusColumns.BIND_STATUS + " INTEGER,"
                + DeviceStatusColumns.ENABLED_STATUS + " INTEGER,"
                + DeviceStatusColumns.HJGH_LOGIN_STATUS + " INTEGER,"
                + DeviceStatusColumns.IN_CALL + " INTEGER, "
                + DeviceStatusColumns.CALL_ALERTING + " INTEGER"
                + ");");
        ContentValues values = new ContentValues();
        values.put(DeviceStatusColumns.ID, 1);
        db.insert(DeviceStatusColumns.DEVICESTATUS_TABLE, null, values);
    ...
    public void dropTables(SQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + Tables.ALLCONTACTS_TABLE);
        db.execSQL("DROP TABLE IF EXISTS " + Tables.HISTORY_CALL_RECORDS_TABLE);
        db.execSQL("DROP TABLE IF EXISTS " + Tables.DEVICE_STATUS_TABLE);
    }
